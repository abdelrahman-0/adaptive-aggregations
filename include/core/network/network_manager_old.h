...
template <typename BufferPage>
class SimpleIngressNetworkManager : public NetworkManagerOld<BufferPage> {
...
class IngressNetworkManager : public NetworkManagerOld<BufferPage> {
    using BaseNetworkManager = NetworkManagerOld<BufferPage>;
...
template <typename BufferPage>
class ConcurrentIngressNetworkManager : public NetworkManagerOld<BufferPage> {
    // needed for dependent lookups
    using BaseNetworkManager = NetworkManagerOld<BufferPage>;
    using BaseNetworkManager::buffers;
    using BaseNetworkManager::buffers_start;
...
class HeterogeneousIngressNetworkManagerOld : public NetworkManagerOld<BufferPage> {
  ...
  public:
    ...
    void post_recvs(u16 dst)
    {
        BufferPage* new_page = block_alloc.get_page();
        auto* sqe = io_uring_get_sqe(&ring);
        io_uring_prep_recv(sqe, dst, new_page, sizeof(BufferPage), MSG_WAITALL);
        auto* user_data = new_page;
        io_uring_sqe_set_data(sqe, tag_pointer(user_data, dst));
...
class MultishotIngressNetworkManager : public NetworkManagerOld<BufferPage> {
  private:
    // needed for dependent lookups
    using NetworkManagerOld<BufferPage>::ring;
    using NetworkManagerOld<BufferPage>::buffers;
    using NetworkManagerOld<BufferPage>::buffers_start;
...
template <concepts::is_communication_page BufferPage>
class SimpleEgressNetworkManager : public NetworkManagerOld<BufferPage> {
    // needed for dependent lookups
    using NetworkManagerOld<BufferPage>::ring;
    using NetworkManagerOld<BufferPage>::buffers;
    using NetworkManagerOld<BufferPage>::free_pages;
    using NetworkManagerOld<BufferPage>::buffers_start;
  ...
  public:
    SimpleEgressNetworkManager(u32 npeers, u32 nwdepth, u32 nbuffers, bool sqpoll, const std::vector<int>& sockets)
        : NetworkManagerOld<BufferPage>(nwdepth, nbuffers, sqpoll, sockets), active_buffer(npeers, nullptr)
    {
...
template <typename BufferPage>
class BufferedEgressNetworkManager : public NetworkManagerOld<BufferPage> {
    using BaseNetworkManager = NetworkManagerOld<BufferPage>;
    using BaseNetworkManager::buffers;
    using BaseNetworkManager::buffers_start;
    using BaseNetworkManager::free_pages;
...
template <typename BufferPage>
class EgressNetworkManagerOld : public NetworkManagerOld<BufferPage> {
    using BaseNetworkManager = NetworkManagerOld<BufferPage>;
    using BaseNetworkManager::buffers;
    using BaseNetworkManager::buffers_start;
    using BaseNetworkManager::free_pages;
...
template <concepts::is_communication_page BufferPage>
class BufferedZeroCopyEgressNetworkManager : public NetworkManagerOld<BufferPage> {
    // needed for dependent lookups
    using NetworkManagerOld<BufferPage>::ring;
    using NetworkManagerOld<BufferPage>::buffers;
    using NetworkManagerOld<BufferPage>::free_pages;
...
template <typename BufferPage>
class ConcurrentBufferedEgressNetworkManager : public NetworkManagerOld<BufferPage> {
    // needed for dependent lookups
    using BaseNetworkManager = NetworkManagerOld<BufferPage>;
    using BaseNetworkManager::buffers;
    using BaseNetworkManager::buffers_start;
