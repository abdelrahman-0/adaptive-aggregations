...
int main(int argc, char* argv[])
{
    ...
    auto monitor_thread = std::jthread{[node_id, is_starting_worker, &config, &coordinator_latch, &task_scheduler] {
        ...
        adapt::WorkerMonitor monitor{egress_network_manager, ingress_network_manager, task_scheduler, is_starting_worker};
    ...
    bool is_active_worker = is_starting_worker;
    ...
    Logger{FLAGS_print_header, FLAGS_csv}
        ...
        .log("policy", FLAGS_policy)
        .log("timeout", FLAGS_timeout)
        .log("static workers", FLAGS_static_workers)
        .log("final workers", task_scheduler.nworkers.load())
