...
#else
using HashtableLocal = ht::PartitionedChainedAggregationHashtable<Groups, Aggregates, idx_mode_entries, idx_mode_slots, fn_agg, MemAlloc, BlockAlloc, SketchLocal, true, false>;
#endif
/* --------------------------------------- */
#if defined(GLOBAL_UNCHAINED_HT)
